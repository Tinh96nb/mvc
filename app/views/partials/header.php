...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo PUBLIC_PATH ?>/css/dataTables.bootstrap.css">
  <link rel="stylesheet" type="text/css" href="<?php echo PUBLIC_PATH ?>/css/dataTables.responsive.css">
...
<div class="sidebar">
  <ul>
    ...
    <?php else:?>
      <li><a href="<?php echo HTTP_ROOT ?>/admin"><i class="fa fa-wrench"></i></i><span>Manager User</span></a></li>
